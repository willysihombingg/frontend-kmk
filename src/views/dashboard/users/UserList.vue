  ...
  <div class="p-4 mt-8 sm:px-8 sm:py-4">
    <div class="p-4 bg-white rounded">
      <div class="flex justify-between">
        ...
        <router-link v-slot="{ href, navigate }" to="/users/create" custom>
          <button
            class="
              flex
              items-center
...
// import { userCreate } from '../../../networking/api-request'
