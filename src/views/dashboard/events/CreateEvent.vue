<template>
  <div class="flex justify-between px-4 mt-4 sm:px-8">
    ...
    <div class="flex items-center space-x-1 text-xs">
      ...
      <router-link to="/events" class="text-gray-600">Events</router-link>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="h-2 w-2"
        fill="none"
      ...
      <router-link to="/events/create" class="text-gray-600"
  ...
  <div class="p-4 mt-8 sm:px-8 sm:py-4">
    <div class="p-4 bg-white rounded">
      <div class="mt-10">
        <form class="space-y-4" @submit.prevent="onEventCreate">
          <div class="shadow overflow-hidden sm:rounded-md">
            ...
            <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
              <router-link v-slot="{ href, navigate }" to="/events" custom>
                <button
                  type="button"
                  class="
                    inline-flex
...
<script>
import { eventCreate } from "../../../networking/api-request";
export default {
  data() {
    return {
      event_name: "",
